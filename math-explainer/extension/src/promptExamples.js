...
exports.getDomainGuidance = getDomainGuidance;
exports.getPromptExamples = getPromptExamples;
const ROLE_COLORS = {
    definition: "#6a00ff",
    quantity: "#0057ff",
    dataset: "#00a35c",
...
exports.PROMPT_VERSION = "backend-prompt-2026-03-11-v5";
const SHARED_SUM_EXAMPLE = {
...
const SIGNALS_DFT_EXAMPLE = {
    ...
    outputExample: {
        ...
        domain: "signals",
        displayLatex: String.raw `\[\class{role-definition}{X_k}=\class{role-normalizer}{\frac{1}{N}}\class{role-operator}{\sum_{\class{role-index}{n}=0}^{N-1}}\class{role-quantity}{x_n}\class{role-operator}{e^{i 2\pi k n / N}}\]`,
        selfDescriptiveSpans: [
...
const ML_CONTRAST_EXAMPLE = {
    ...
    outputExample: {
        ...
        domain: "ml",
        displayLatex: String.raw `\[\class{role-definition}{\Delta \mu}=\class{role-positive-term}{\frac{1}{|D_{safe}|}\sum_{x \in \class{role-dataset}{D_{safe}}} a(x)}-\class{role-negative-term}{\frac{1}{|D_{harm}|}\sum_{x \in \class{role-dataset}{D_{harm}}} a(x)}\]`,
        selfDescriptiveSpans: [
            textStory("This "),
...
const CALCULUS_CONTOUR_EXAMPLE = {
    ...
    outputExample: {
        ...
        domain: "calculus",
        displayLatex: String.raw `\[\class{role-definition}{f'(a)}=\class{role-operator}{\lim_{\gamma \to a}}\class{role-normalizer}{\frac{i}{2A(\gamma)}}\class{role-operator}{\oint_{\gamma}}\class{role-quantity}{f(z)\,d\bar z}\]`,
        selfDescriptiveSpans: [
...
function buildHighlight(label, latex, role, explanation) {
    return {
        label,
        latex,
        role,
...
function latexStory(latex, role) {
    return {
        text: "",
        latex,
        role: role ?? ""
